...
def optimize_global_seton(*args, **kwargs):
    raise DeprecationWarning(
        "optimize_global_seton is deprecated. Use OptimizerFactory.get_strategy('heuristic')"
    )


def optimize_with_gurobi(*args, **kwargs):
    raise DeprecationWarning(
        "optimize_with_gurobi is deprecated. Use OptimizerFactory.get_strategy('gurobi')"
    )
