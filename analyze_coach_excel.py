...
try:
    ...
    for sheet_name in xl.sheet_names:
        ...
        for col in df.columns:
            ...
            print(f"  - {col}: {df[col].dtype} ({unique_count} unique values, sample: {sample})")
    ...
    summary_file = r"c:\Users\Microsoft\Desktop\SwimAi\swim_ai_reflex\COACH_EXCEL_ANALYSIS.txt"
