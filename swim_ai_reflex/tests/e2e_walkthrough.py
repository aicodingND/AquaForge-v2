...
def run_walkthrough():
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            print(
                "     Run: source .venv/bin/activate && python run_server.py --mode api"
            )
            browser.close()
            sys.exit(1)
        ...
        try:
            ...
            if demo_buttons:
                ...
                print(
                    "  ℹ️  No Demo Data button found, proceeding with manual upload check"
                )
        ...
        try:
            ...
            if optimize_button:
                ...
                print("  ⚠️  No optimize button found - may need data first")
