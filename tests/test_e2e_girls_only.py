"""
E2E Test: Seton vs Trinity - Girls Events Only (No Diving, No Relays)
"""
import sys
import os
import pandas as pd
...
def filter_girls_events_only(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df_no_diving = df_no_relays[~df_no_relays['event'].str.contains('Diving', case=False, na=False)].copy()
...
if __name__ == "__main__":
    asyncio.run(run_e2e_girls_only())
