            ...
            for page in pdf.pages:
                ...
                for line in lines:
                    ...
                    if is_result_first:
                        ...
                        while remaining and (len(remaining[0]) <= 2 or remaining[0].lower() in ('y', 'l', 's', 'x', 'f', 'p')):
                        ...
                        for i, p in enumerate(remaining):
                            ...
                            if p_clean in grade_map or re_date.match(p) or any(k in p_clean for k in TEAM_KEYWORDS):
