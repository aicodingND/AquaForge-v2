...
def test_exports():
    ...
    results = [
        {'swimmer': 'Lionel Martinez', 'event': '100 Yard Freestyle', 'time': 47.16, 'team': 'seton', 'points': 8.0, 'place': 1},
        {'swimmer': 'Bennett Ellis', 'event': '100 Yard Freestyle', 'time': 66.1, 'team': 'seton', 'points': 2.0, 'place': 6},
        {'swimmer': 'Caleb Fiala', 'event': '100 Yard Freestyle', 'time': 50.14, 'team': 'opponent', 'points': 6.0, 'place': 2},
        {'swimmer': 'Brenton Anderson', 'event': '100 Yard Freestyle', 'time': 53.75, 'team': 'opponent', 'points': 5.0, 'place': 3},
    ]
    ...
    try:
        xlsx_data = export_service.to_xlsx(
            results, seton_score, opponent_score,
            seton_team_name='Seton', opponent_team_name='Immanuel'
        )
        if xlsx_data:
